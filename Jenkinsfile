pipeline {
  ...
  stages {
    ...
    stage ('git clone') {
      steps {
	sh 'ssh rd6-admin@10.251.40.11 cd /home/rd6-admin/playbook/; git pull'
	sh 'ssh rd6-admin@10.251.40.11 cp /home/rd6-admin/playbook/compose/qa/docker-compose-up.yml /tmp/jks_rey/docker-compose-up.yml'
